...
class SpecView(PermissionRequiredMixin, PrintableMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return self.render_printable(is_html, self.template_name, context_data, header_template="orders/printable/specs-header.html", pdf_options={"orientation": "landscape"})
